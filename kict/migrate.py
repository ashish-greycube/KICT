...
def custom_data_creation() :
	create_document_naming_rule()
	create_role_docs()

def create_document_naming_rule():
...
def create_role_docs():
	operation_mis=frappe.db.exists('Role', 'Operations MIS')
	if operation_mis==None:
		doc = frappe.new_doc('Role')
		doc.role_name = "Operations MIS"
		doc.insert(ignore_permissions=True)
	else:
		print("Role of Operations MIS is already exist")		

	operation_team=frappe.db.exists('Role', 'Operations Team')
	if operation_team==None:
		doc = frappe.new_doc('Role')
		doc.role_name =  "Operations Team"
		doc.insert(ignore_permissions=True)
	else:
		print("Role of Operations Team is already exist")
